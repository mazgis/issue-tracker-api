package lt.mazgis.issuetracker.api.developer;
...
public class DeveloperRestApiService {
	...
	public List<Developer> listDeveloper() {
		return this.developerService.listOfDevelopers();
	}
	...
	@Consumes(MediaType.TEXT_PLAIN)
	@Produces(MediaType.APPLICATION_JSON)
	public Developer updateDeveloper(@PathParam("id") final long id, final String name) throws NotFoundException {
		return this.developerService.update(id, name);
	}
